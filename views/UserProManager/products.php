...
<div class="container-fluid" style="margin-bottom: 80px;">
    <div class="row">
        <div class="col-md-12">
            <h1 class="shop_h1 text-center">MY PROFILE</h1>
        </div>
    </div>
        ...
        <div class="container">
            ...
            <a href="/lanaya/user/product/add" class="product_a"><div class="col-md-4 column"><div class="color-overlay"></div><img src="/lanaya/style/img/buy.jpg" class="img_thumb" alt=""><span id="addproduct" class="text-center">Click here and add a new product!</span></a></div>
                <?php foreach($products as $product): ?>
                    <div class="col-md-4">
                        <a href="/lanaya/user/product/edit/<?php echo $product->id; ?>" class="product_a"><span><?php echo $product->title; ?></span>
                        <div class="color-overlay"></div>
                        <img src="<?php echo $product->image ?>" alt="" class="img_thumb product_img"></a>
                </div>
            <?php endforeach; ?>
        </div>
        <div class="col-md-1"></div>
